...
- Statut : OPEN — la config Playwright utilise maintenant `CHROME_EXECUTABLE_PATH` quand disponible, ce qui débloque l'exécution locale sans installer les navigateurs Playwright.
