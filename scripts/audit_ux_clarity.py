...
def main() -> None:
    ...
    require(app, "v37ReadableMetricHtml", "beginner-readable table metrics")
    require(app, "Priorité : note globale 0-100", "priority score tooltip")
    require(app, "Cote non prioritaire", "old/unverified odd priority cap")
