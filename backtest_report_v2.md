...
Généré : 2026-05-02T05:54:03Z
Source modèle : `pronostics.html` via `scripts/model_loader.py` (V8 embarqué, zéro duplication)
Univers : 491 picks sur 2026-04-23T18:45Z → 2026-05-02T01:45Z
Bankroll simulée (Kelly 0.25× cap 10%) : **100u → 279.14u**

> 📊 **v2** évalue la vraie fonction `predictMatch` qui vit dans `pronostics.html`. Les chiffres ci-dessous reflètent ce que le dashboard aurait fait si tu avais parié flat 1u chaque pick. La baseline marché reste dans `backtest_baselines.py` / `backtest_report.md`.

## 🟢 Vue d'ensemble

- **491 picks** · 267 gagnés / 224 perdus · WR **54.4%**
- ROI flat (1u/pick) : **+0.96%** (+4.73u cumulé)
- Kelly 0.25× cap 10% : cumulé **+179.14u**
- Cote moyenne : 1.98 · Pick prob moyenne : 52.9%
- **Brier** : 0.2291 (0 = parfait, 0.25 = pile/face)
- **Log-loss** : 0.6505 (plus bas = mieux calibré)
...
|---|---:|---:|---:|---:|---:|
| `lock` | 25 | 84% | 🟢 +6.4% | +21.81u | 0.1451 |
| `standard` | 1 | 100% | 🟢 +54.0% | +0.00u | 0.1472 |
| `skip` | 465 | 53% | 🟢 +0.6% | +157.33u | 0.2338 |

## Par sport

| Sport | N | WR | ROI flat | Kelly cumul | Brier |
|---|---:|---:|---:|---:|---:|
| football | 389 | 53% | 🟢 +2.0% | +178.55u | 0.2254 |
| baseball | 58 | 60% | 🟢 +4.4% | +0.59u | 0.244 |
